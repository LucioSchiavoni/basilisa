...
export function ChangePasswordForm({ isSettingNew }: { isSettingNew: boolean }) {
        ...
        <div className="w-full max-w-md bg-white dark:bg-card rounded-3xl shadow-xl p-8 space-y-6 text-center">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold">
              {isSettingNew ? "¡Contraseña agregada!" : "¡Contraseña actualizada!"}
            </h1>
            <p className="text-muted-foreground">
              {isSettingNew
                ? "Ya podés entrar con tu email y esta contraseña."
      ...
      <div className="w-full max-w-md bg-white dark:bg-card rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-bold">
              {isSettingNew ? "Agregar contraseña" : "Cambiar contraseña"}
            </h1>
            <p className="text-sm text-muted-foreground">
              {isSettingNew
                ? "Agregá una contraseña para poder entrar con tu email también"
          ...
          <form action={formAction} className="space-y-4">
            <input type="hidden" name="isSettingNew" value={isSettingNew ? "1" : ""} />
