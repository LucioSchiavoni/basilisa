      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            />
            <MetricRow label="Diversidad léxica" value={fmtPct(s.type_token_ratio)} />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <MetricRow
              ...
              color={
                l.avg_frequency >= 7 ? "green" : l.avg_frequency <= 4 ? "red" : "neutral"
              }
            />
            <MetricRow
            ...
            <MetricRow
              ...
              color={
                l.avg_imageability >= 6 ? "green" : l.avg_imageability <= 3 ? "red" : "neutral"
              }
            />
            <MetricRow
